...
/*Crea una lista (List) de cadenas de texto que r
epresenten nombres de colores. Realiza operaciones como agregar nuevos
 colores, eliminar colores y mostrar la lista.*/
public class Main {
